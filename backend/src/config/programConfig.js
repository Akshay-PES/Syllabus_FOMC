...
const PROGRAMS = {
  ...
  BCOM: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Commerce programmes at top QS-ranked global and Indian universities (MIT, Stanford, London School of Economics, University of Oxford, University of Melbourne, National University of Singapore, SRCC Delhi University)',
    benchmarks: 'MIT, Stanford University, London School of Economics (LSE), University of Oxford, University of Melbourne, National University of Singapore (NUS), University of Toronto, SRCC (Delhi University), UGC model curriculum for Commerce',
...
- Language and depth must be appropriate for undergraduate students`,
  ...
  BCOM_ACCA: {
    ...
    benchmarks: 'ACCA Global Qualification Curriculum, MIT, London School of Economics (LSE), University of Oxford, University of Melbourne, National University of Singapore (NUS), Oxford Brookes University (ACCA partnership), SRCC Delhi, UGC guidelines',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the ACCA paper and the specific learning outcome (e.g., "FA Paper — LO B3: Prepare a trial balance") it maps to. This mapping is required for ACCA accreditation.`,
  ...
  BCOM_CMA: {
    ...
    benchmarks: 'ICMAI CMA Qualification Curriculum, IMA (USA) CMA Curriculum, MIT, Stanford University, London School of Economics (LSE), University of Oxford, University of Melbourne, SRCC Delhi University, UGC model Commerce curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the ICMAI CMA paper and the specific syllabus module (e.g., "CMA Intermediate Paper 8 — Module 3: Marginal Costing") it maps to. This mapping is required for ICMAI accreditation.`,
  ...
  BCOM_CFA: {
    ...
    benchmarks: 'CFA Institute Curriculum, MIT, Stanford University, London School of Economics (LSE), University of Oxford, National University of Singapore (NUS), University of Toronto, SRCC Delhi University, UGC model Commerce curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the CFA topic area and specific LOS it maps to. This mapping supports CFA Institute University Affiliation Programme requirements.`,
  ...
  BCOM_CA: {
    ...
    benchmarks: 'ICAI CA Curriculum, MIT, London School of Economics (LSE), University of Oxford, University of Melbourne, National University of Singapore (NUS), IFRS Foundation standards, SRCC Delhi University, UGC model Commerce curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the ICAI CA paper and the specific syllabus module (e.g., "CA Intermediate Paper 1 — Accounting Standards") it maps to. This mapping is required for ICAI accreditation alignment.`,
  ...
  BBA: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Business Administration programmes at top QS-ranked global and Indian institutions (Harvard University, INSEAD, London Business School, MIT Sloan, University of Cambridge, NUS Business School, IIM Indore IPM)',
    benchmarks: 'Harvard University, INSEAD, London Business School (UK), MIT Sloan, University of Cambridge, NUS Business School (Singapore), HEC Paris, IIM Indore (IPM), UGC model curriculum for BBA',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Reference relevant Indian business environment, regulations, and examples`,
  ...
  BBA_ANALYTICS: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Business Analytics programmes at top QS-ranked global and Indian institutions (MIT, Stanford University, ETH Zurich, Carnegie Mellon, University of Oxford, National University of Singapore)',
    benchmarks: 'MIT (Analytics), Stanford University, ETH Zurich (Switzerland), Carnegie Mellon University (Business Analytics), University of Oxford, National University of Singapore (NUS), University of Melbourne, UGC model curriculum',
...
- Align with UGC guidelines while incorporating current industry analytics practices`,
  ...
  BBA_SPORTS: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Sports Management programmes at top QS-ranked global institutions (Loughborough University, University of Sydney, University of Queensland, University of British Columbia, KU Leuven, Deakin University)',
    benchmarks: 'Loughborough University (UK), University of Sydney (Australia), University of Queensland (Australia), University of British Columbia (Canada), KU Leuven (Belgium), Deakin University (Australia), UGC guidelines',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language and depth must be appropriate for undergraduate students`,
  ...
  BA_LLB: {
    ...
    level: 'UG',
    group: 'UG Law',
    persona: 'senior legal academic curriculum designer specialising in five-year integrated BA LLB programmes at top QS-ranked global law schools and National Law Universities (University of Oxford, University of Cambridge, Harvard Law School, Yale Law School, London School of Economics, NLSIU Bangalore, NLU Delhi)',
    benchmarks: 'University of Oxford Faculty of Law, University of Cambridge Faculty of Law, Harvard Law School, Yale Law School, London School of Economics (LSE), National University of Singapore (NUS) Faculty of Law, University of Melbourne Law School, NLSIU Bangalore, NLU Delhi, NALSAR Hyderabad, Bar Council of India (BCI) prescribed curriculum',
...
- LANDMARK CASES (MANDATORY): Each unit must list 5–10 specific landmark judgments (Supreme Court / High Court / relevant international courts) directly relevant to that unit's topics. Format: Case Name (Year) — Court — one-line significance. This is required for BCI accreditation and law programme quality standards.`,
  ...
  BBA_LLB: {
    ...
    level: 'UG',
    group: 'UG Law',
    persona: 'senior legal and business academic curriculum designer specialising in five-year integrated BBA LLB programmes at top QS-ranked global law schools and Indian institutions (University of Oxford, University of Cambridge, Harvard Law School, Yale Law School, London School of Economics, NLSIU Bangalore, Symbiosis Law School)',
    benchmarks: 'University of Oxford Faculty of Law, University of Cambridge Faculty of Law, Harvard Law School, Yale Law School, London School of Economics (LSE), National University of Singapore (NUS) Faculty of Law, University of Melbourne Law School, NLSIU Bangalore, Symbiosis Law School Pune, Bar Council of India (BCI) prescribed curriculum',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and Evaluate (L5)',
...
- LANDMARK CASES (MANDATORY): Each unit must list 5–10 specific landmark judgments (Supreme Court / High Court / relevant tribunals / international courts) directly relevant to that unit's topics. Format: Case Name (Year) — Court — one-line significance. This is required for BCI accreditation and law programme quality standards.`,
  ...
  LLB: {
    ...
    level: 'UG',
    group: 'UG Law',
    persona: 'senior legal academic curriculum designer specialising in three-year LLB programmes at top QS-ranked global law schools and National Law Universities (University of Oxford, University of Cambridge, Harvard Law School, Yale Law School, London School of Economics, NLSIU Bangalore, NLU Delhi)',
    benchmarks: 'University of Oxford Faculty of Law, University of Cambridge Faculty of Law, Harvard Law School, Yale Law School, London School of Economics (LSE), National University of Singapore (NUS) Faculty of Law, University of Melbourne Law School, NLSIU Bangalore, NLU Delhi, Faculty of Law Delhi University, Bar Council of India (BCI) prescribed curriculum',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and Evaluate (L5)',
...
- LANDMARK CASES (MANDATORY): Each unit must list 5–10 specific landmark judgments (Supreme Court / High Court / relevant international courts) directly relevant to that unit's topics. Format: Case Name (Year) — Court — one-line significance. This is required for BCI accreditation and law programme quality standards.`,
  ...
  BSC_PSYCHOLOGY: {
    ...
    persona: 'senior academic curriculum designer specialising in undergraduate Psychology programmes at top QS-ranked global and Indian universities (Harvard University, Stanford University, University of Oxford, University of Cambridge, University of Amsterdam, University of British Columbia, University of Melbourne)',
    benchmarks: 'Harvard University, Stanford University, University of Oxford, University of Cambridge, University of Amsterdam (Netherlands), University of British Columbia (Canada), University of Melbourne (Australia), Delhi University, APA (American Psychological Association) guidelines for undergraduate Psychology, UGC model curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language, terminology, and conceptual depth must be appropriate for undergraduate Psychology students`,
  ...
  BSC_ECONOMICS: {
    ...
    level: 'UG',
    group: 'UG Science / Social Science',
    persona: 'senior academic curriculum designer specialising in undergraduate Economics programmes at top QS-ranked global and Indian universities (MIT, Harvard University, Stanford University, London School of Economics, University of Oxford, University of Cambridge, Delhi School of Economics)',
    benchmarks: 'MIT (Economics), Harvard University, Stanford University, London School of Economics (LSE), University of Oxford, University of Cambridge, ETH Zurich, Delhi School of Economics (DSE), UGC model curriculum for Economics',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and introductory Evaluate (L5)',
...
- Mathematical rigor must be appropriate for BSc-level students`,
  ...
  BSC_JMC: {
    ...
    level: 'UG',
    group: 'UG Science / Social Science',
    persona: 'senior academic curriculum designer specialising in undergraduate Journalism and Mass Communication programmes at top QS-ranked global and Indian universities (University of Amsterdam, London School of Economics, University of Southern California, Nanyang Technological University, University of Melbourne, IIMC Delhi)',
    benchmarks: 'University of Amsterdam (Netherlands), London School of Economics (LSE), University of Southern California (USC), University of Wisconsin-Madison, Nanyang Technological University (NTU Singapore), University of Melbourne, Goldsmiths University of London, IIMC (Indian Institute of Mass Communication) Delhi, UGC model curriculum for Journalism & Mass Communication',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language and depth must be appropriate for undergraduate students`,
  ...
  BHEM: {
    ...
    persona: 'senior academic curriculum designer specialising in undergraduate Hotel and Event Management programmes at top QS-ranked global hospitality institutions (EHL Ecole hôtelière de Lausanne, Cornell University, Hong Kong Polytechnic University, University of Nevada Las Vegas, Les Roches, University of Surrey)',
    benchmarks: 'EHL Ecole hôtelière de Lausanne (Switzerland), Cornell University School of Hotel Administration (USA), Hong Kong Polytechnic University, University of Nevada Las Vegas (UNLV), Glion Institute of Higher Education (Switzerland), Les Roches (Switzerland), University of Surrey (UK), NCHMCT model curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language and depth must be appropriate for undergraduate hospitality management students`,
  ...
  MSC_PSYCHOLOGY: {
    ...
    level: 'PG',
    group: 'Postgraduate',
    persona: 'senior academic curriculum designer specialising in postgraduate Psychology programmes at top QS-ranked global and Indian universities (Harvard University, Stanford University, University of Oxford, University of Cambridge, University of Amsterdam, University of Melbourne, NIMHANS Bangalore)',
    benchmarks: 'Harvard University, Stanford University, University of Oxford, University of Cambridge, University of Amsterdam (Netherlands), University of British Columbia (Canada), University of Melbourne (Australia), NIMHANS Bangalore, TISS Mumbai, APA (American Psychological Association) guidelines for graduate Psychology, UGC model curriculum for MSc Psychology',
    bloomsEmphasis: 'Apply (L3), Analyze (L4), Evaluate (L5), and Create (L6)',
...
- Depth and rigour must be appropriate for postgraduate students preparing for clinical practice, research careers, or doctoral studies`,
  ...
  LLM: {
    ...
    level: 'PG',
    group: 'Postgraduate',
    persona: 'senior legal academic curriculum designer specialising in postgraduate law programmes at top QS-ranked global law schools and National Law Universities (University of Oxford, University of Cambridge, Harvard Law School, Yale Law School, London School of Economics, NLSIU Bangalore, NLU Delhi)',
    benchmarks: 'University of Oxford Faculty of Law, University of Cambridge Faculty of Law, Harvard Law School, Yale Law School, London School of Economics (LSE), National University of Singapore (NUS) Faculty of Law, University of Melbourne Law School, NLSIU Bangalore, NLU Delhi, NALSAR Hyderabad, Bar Council of India (BCI) standards for LLM programmes',
    bloomsEmphasis: 'Apply (L3), Analyze (L4), Evaluate (L5), and Create (L6)',
