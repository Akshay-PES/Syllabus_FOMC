...
- Language and depth must be appropriate for undergraduate students`,
    pos: [
      { id: 'PO1', domain: 'Disciplinary Knowledge', statement: 'Apply the knowledge of commerce, accounting, and business to real-world financial and commercial scenarios.' },
      { id: 'PO2', domain: 'Critical Thinking',       statement: 'Demonstrate analytical skills to evaluate business and financial decisions.' },
      { id: 'PO3', domain: 'Communication',            statement: 'Communicate effectively in professional and business contexts.' },
      { id: 'PO4', domain: 'Problem Solving',          statement: 'Identify and solve problems related to accounting, taxation, and commercial law.' },
      { id: 'PO5', domain: 'Ethics & Values',          statement: 'Exhibit professional ethics and integrity in business and financial practice.' },
      { id: 'PO6', domain: 'Teamwork',                 statement: 'Work effectively in teams and collaborative environments.' },
      { id: 'PO7', domain: 'Technology Use',           statement: 'Use accounting and business software tools effectively.' },
      { id: 'PO8', domain: 'Lifelong Learning',        statement: 'Pursue professional certifications and continuous learning in commerce.' },
    ],
    psos: [
