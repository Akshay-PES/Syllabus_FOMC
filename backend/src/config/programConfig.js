...
- Language and depth must be appropriate for undergraduate students`,
  ...
  BA_LLB: {
    ...
    level: 'UG',
    group: 'UG Law',
    persona: 'senior legal academic curriculum designer specialising in five-year integrated BA LLB programmes at National Law Universities and top international law schools (NLSIU Bangalore, NLU Delhi, NALSAR Hyderabad, Harvard Law School, Oxford University, National University of Singapore Faculty of Law)',
    benchmarks: 'NLSIU Bangalore, NLU Delhi, NALSAR Hyderabad, Symbiosis Law School Pune, Harvard Law School, Oxford University Faculty of Law, NUS Faculty of Law (Singapore), Bar Council of India (BCI) prescribed curriculum',
...
- LANDMARK CASES (MANDATORY): Each unit must list 5–10 specific landmark judgments (Supreme Court / High Court / relevant international courts) directly relevant to that unit's topics. Format: Case Name (Year) — Court — one-line significance. This is required for BCI accreditation and law programme quality standards.`,
  ...
  BBA_LLB: {
    ...
    level: 'UG',
    group: 'UG Law',
    persona: 'senior legal and business academic curriculum designer specialising in five-year integrated BBA LLB programmes at top Indian and international institutions (Symbiosis Law School Pune, NMIMS School of Law, O.P. Jindal Global Law School, Georgetown University Law Center, University of Melbourne Law School)',
    benchmarks: 'Symbiosis Law School Pune, NMIMS School of Law Mumbai, O.P. Jindal Global Law School, Georgetown University Law Center (USA), University of Melbourne Law School (Australia), Bar Council of India (BCI) prescribed curriculum',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and Evaluate (L5)',
...
- LANDMARK CASES (MANDATORY): Each unit must list 5–10 specific landmark judgments (Supreme Court / High Court / relevant tribunals / international courts) directly relevant to that unit's topics. Format: Case Name (Year) — Court — one-line significance. This is required for BCI accreditation and law programme quality standards.`,
  ...
  LLB: {
    ...
    level: 'UG',
    group: 'UG Law',
    persona: 'senior legal academic curriculum designer specialising in three-year LLB programmes at National Law Universities, top Indian law colleges, and leading international law schools (NLSIU Bangalore, NLU Delhi, Faculty of Law Delhi University, University of London LLB, King\'s College London)',
    benchmarks: 'NLSIU Bangalore, NLU Delhi, Faculty of Law Delhi University, Government Law College Mumbai, University of London (LLB), King\'s College London, University of Sydney Law School, Bar Council of India (BCI) prescribed curriculum',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and Evaluate (L5)',
...
- Language, terminology, and conceptual depth must be appropriate for undergraduate Psychology students`,
  ...
  BSC_ECONOMICS: {
    ...
    level: 'UG',
    group: 'UG Science / Social Science',
    persona: 'senior academic curriculum designer specialising in undergraduate Economics programmes at top Indian and international universities (Delhi School of Economics, Ashoka University, London School of Economics, MIT, University of Chicago, National University of Singapore)',
    benchmarks: 'Delhi School of Economics (DSE), St. Xavier\'s College Mumbai, Ashoka University, London School of Economics (LSE), MIT (Economics), University of Chicago, National University of Singapore (NUS), UGC model curriculum for Economics',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and introductory Evaluate (L5)',
...
- Mathematical rigor must be appropriate for BSc-level students`,
  ...
  BSC_JMC: {
    ...
    level: 'UG',
    group: 'UG Science / Social Science',
    persona: 'senior academic curriculum designer specialising in undergraduate Journalism and Mass Communication programmes at top Indian and international universities (IIMC Delhi, Symbiosis Institute of Media and Communication, AJK MCRC Jamia Millia Islamia, Columbia Journalism School, University of Missouri, Northwestern University Medill)',
    benchmarks: 'IIMC (Indian Institute of Mass Communication) Delhi, Symbiosis Institute of Media and Communication Pune, AJK MCRC Jamia Millia Islamia, Columbia University School of Journalism (USA), University of Missouri (Journalism), Northwestern University Medill (USA), UGC model curriculum for Journalism & Mass Communication',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language and depth must be appropriate for undergraduate students`,
  ...
  BHEM: {
    ...
    benchmarks: 'IHM Mumbai, IHM Delhi, WGSHA Manipal University, Ecole Hôtelière de Lausanne (Switzerland), Les Roches (Switzerland), Cornell University School of Hotel Administration (USA), NCHMCT model curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
