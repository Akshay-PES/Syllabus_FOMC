...
const PROGRAMS = {
  ...
  BCOM: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Commerce programmes at top QS-ranked universities offering BCom degrees (University of Melbourne, University of Sydney, UNSW Sydney, University of Toronto Rotman, McGill University, Monash University)',
    benchmarks: 'University of Melbourne (BCom), University of Sydney (BCom), UNSW Sydney (BCom), University of Toronto Rotman (BCom), McGill University Desautels (BCom), Monash University (BCom), University of Auckland (BCom), SRCC Delhi University (BCom Hons), UGC model curriculum for Commerce',
...
- Language and depth must be appropriate for undergraduate students`,
  ...
  BCOM_ACCA: {
    ...
    benchmarks: 'ACCA Global Qualification Curriculum, University of Melbourne (BCom — CPA/CA ANZ), University of Sydney (BCom — ACCA exemptions), UNSW Sydney (BCom), University of Toronto Rotman (BCom), McGill University (BCom), Oxford Brookes University (ACCA partnership), SRCC Delhi (BCom Hons), UGC guidelines',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the ACCA paper and the specific learning outcome (e.g., "FA Paper — LO B3: Prepare a trial balance") it maps to. This mapping is required for ACCA accreditation.`,
  ...
  BCOM_CMA: {
    ...
    benchmarks: 'ICMAI CMA Qualification Curriculum, IMA (USA) CMA Curriculum, University of Melbourne (BCom), University of Sydney (BCom), UNSW Sydney (BCom), University of Toronto Rotman (BCom), Monash University (BCom), SRCC Delhi University (BCom Hons), UGC model Commerce curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the ICMAI CMA paper and the specific syllabus module (e.g., "CMA Intermediate Paper 8 — Module 3: Marginal Costing") it maps to. This mapping is required for ICMAI accreditation.`,
  ...
  BCOM_CFA: {
    ...
    benchmarks: 'CFA Institute Curriculum, UNSW Sydney (BCom — CFA affiliate), University of Toronto Rotman (BCom — CFA pathway), McGill University (BCom — CFA pathway), University of Melbourne (BCom), Monash University (BCom — CFA), SRCC Delhi University (BCom Hons), UGC model Commerce curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the CFA topic area and specific LOS it maps to. This mapping supports CFA Institute University Affiliation Programme requirements.`,
  ...
  BCOM_CA: {
    ...
    benchmarks: 'ICAI CA Curriculum, University of Melbourne (BCom — CA ANZ), University of Sydney (BCom — CA ANZ), UNSW Sydney (BCom), University of Toronto Rotman (BCom — CPA Canada), University of Cape Town (BCom — SAICA CA), IFRS Foundation standards, SRCC Delhi University (BCom Hons), UGC model Commerce curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- EXAM ALIGNMENT (MANDATORY): For each Course Outcome (CO), explicitly identify the ICAI CA paper and the specific syllabus module (e.g., "CA Intermediate Paper 1 — Accounting Standards") it maps to. This mapping is required for ICAI accreditation alignment.`,
  ...
  BBA: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Business Administration programmes at top QS-ranked universities offering BBA degrees (NUS, HKUST, HKU, University of Michigan Ross, UT Austin McCombs, SMU Singapore)',
    benchmarks: 'National University of Singapore NUS (BBA), Hong Kong University of Science and Technology HKUST (BBA), University of Hong Kong HKU (BBA), Chinese University of Hong Kong CUHK (BBA), University of Michigan Ross (BBA), University of Texas at Austin McCombs (BBA), Singapore Management University SMU (BBA), IIM Indore (IPM), UGC model curriculum for BBA',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Reference relevant Indian business environment, regulations, and examples`,
  ...
  BBA_ANALYTICS: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Business Analytics programmes at top QS-ranked universities offering BBA/BSc Analytics degrees (NUS, University of Michigan Ross, UT Austin McCombs, HKUST)',
    benchmarks: 'National University of Singapore NUS (BSc Business Analytics), University of Michigan Ross (BBA — Analytics concentration), University of Texas at Austin McCombs (BBA — MIS/Analytics), HKUST (BBA — IS & Operations Management), NUS (BBA — Analytics & Operations concentration), UGC model curriculum',
...
- Align with UGC guidelines while incorporating current industry analytics practices`,
  ...
  BBA_SPORTS: {
    ...
    level: 'UG',
    group: 'UG Commerce',
    persona: 'senior academic curriculum designer specialising in undergraduate Sports Management programmes at top QS-ranked universities in Sports-related Subjects (Loughborough University, Deakin University, University of Michigan, Ohio State University, University of Sydney)',
    benchmarks: 'Loughborough University (BSc Sport Management — QS #1 Sports), Deakin University (Bachelor of Sport Management), University of Michigan (BSc Sport Management), Ohio State University (BS Sport Industry), University of Sydney (Bachelor of Applied Science — Exercise & Sport Science), University of Queensland (Bachelor of Exercise & Sport Sciences), UGC guidelines',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- LANDMARK CASES (MANDATORY): Each unit must list 5–10 specific landmark judgments (Supreme Court / High Court / relevant international courts) directly relevant to that unit's topics. Format: Case Name (Year) — Court — one-line significance. This is required for BCI accreditation and law programme quality standards.`,
  ...
  BSC_PSYCHOLOGY: {
    ...
    persona: 'senior academic curriculum designer specialising in undergraduate Psychology programmes at top QS-ranked universities offering BSc/BA Psychology (University of Oxford, University of Cambridge, UCL, University of Toronto, University of British Columbia, University of Edinburgh, University of Amsterdam)',
    benchmarks: 'University of Oxford (BA Experimental Psychology), University of Cambridge (BA Psychological & Behavioural Sciences), UCL (BSc Psychology), University of Toronto (BSc Psychology), University of British Columbia (BSc Psychology), University of Edinburgh (BSc Psychology), University of Amsterdam (BSc Psychology), Delhi University (BA Hons Psychology), APA (American Psychological Association) guidelines for undergraduate Psychology, UGC model curriculum',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language, terminology, and conceptual depth must be appropriate for undergraduate Psychology students`,
  ...
  BSC_ECONOMICS: {
    ...
    level: 'UG',
    group: 'UG Science / Social Science',
    persona: 'senior academic curriculum designer specialising in undergraduate Economics programmes at top QS-ranked universities offering BSc/BA Economics (London School of Economics, University of Cambridge, UCL, University of Toronto, NUS, University of Warwick, University of Edinburgh)',
    benchmarks: 'London School of Economics (BSc Economics), University of Cambridge (BA Economics), UCL (BSc Economics), University of Toronto (BSc Economics), National University of Singapore NUS (BSc Economics), University of Warwick (BSc Economics), University of Edinburgh (BSc Economics), Delhi University (BA Hons Economics), UGC model curriculum for Economics',
    bloomsEmphasis: 'Understand (L2), Apply (L3), Analyze (L4), and introductory Evaluate (L5)',
...
- Mathematical rigor must be appropriate for BSc-level students`,
  ...
  BSC_JMC: {
    ...
    level: 'UG',
    group: 'UG Science / Social Science',
    persona: 'senior academic curriculum designer specialising in undergraduate Journalism and Mass Communication programmes at top QS-ranked universities offering UG media/journalism degrees (USC Annenberg, LSE, Northwestern Medill, University of Amsterdam, NTU Singapore, University of Wisconsin-Madison)',
    benchmarks: 'University of Southern California USC Annenberg (BA Journalism / BA Communication), London School of Economics (BSc Media and Communications), Northwestern University Medill (BSJ Journalism), University of Amsterdam (BSc Communication Science), Nanyang Technological University NTU (BA Communication Studies), University of Wisconsin-Madison (BSc Journalism), QUT Queensland University of Technology (Bachelor of Communication), AJK MCRC Jamia Millia Islamia, UGC model curriculum for Journalism & Mass Communication',
    bloomsEmphasis: 'Remember (L1), Understand (L2), Apply (L3), and Analyze (L4)',
...
- Language and depth must be appropriate for undergraduate hospitality management students`,
  ...
  MSC_PSYCHOLOGY: {
    ...
    level: 'PG',
    group: 'Postgraduate',
    persona: 'senior academic curriculum designer specialising in postgraduate Psychology programmes at top QS-ranked universities offering MSc/MA Psychology (University of Oxford, University of Cambridge, UCL, University of Amsterdam, University of Melbourne, University of Edinburgh, University of British Columbia)',
    benchmarks: 'University of Oxford (MSc Experimental Psychology), University of Cambridge (MPhil Psychology), UCL (MSc Psychology), University of Amsterdam (MSc Psychology), University of Melbourne (Master of Psychology), University of Edinburgh (MSc Psychology), University of British Columbia (MA Psychology), King\'s College London (MSc Psychology), NIMHANS Bangalore (MPhil Clinical Psychology), TISS Mumbai (MA Applied Psychology), APA (American Psychological Association) guidelines for graduate Psychology, UGC model curriculum for MSc Psychology',
    bloomsEmphasis: 'Apply (L3), Analyze (L4), Evaluate (L5), and Create (L6)',
