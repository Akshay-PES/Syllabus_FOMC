...
export default function ActionBar({ output, docxFilename }) {
  ...
  return (
    <div className="flex flex-wrap gap-3">
      ...
      <button
        onClick={handleCopy}
        className="flex items-center gap-2 px-4 py-2 rounded-lg border-2 border-pes-navy bg-white text-sm font-semibold text-pes-navy hover:bg-pes-navy-light transition-colors"
      >
        {copied ? (
          <>
