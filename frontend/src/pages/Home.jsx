...
const BENCHMARKS = {
  ...
  BBA_LLB:        'Symbiosis Law, O.P. Jindal, Georgetown, BCI curriculum',
  LLB:            'NLSIU, NLU Delhi, King\'s College London, University of Sydney, BCI',
  BSC_PSYCHOLOGY: 'Delhi University, UCL, University of Melbourne, APA guidelines',
  BSC_ECONOMICS:  'DSE, Ashoka, LSE, MIT, University of Chicago',
  BSC_JMC:        'IIMC Delhi, Columbia Journalism, Northwestern Medill, Symbiosis',
  BHEM:           'IHM Mumbai, Ecole Hôtelière de Lausanne, Cornell, NCHMCT',
  MSC_PSYCHOLOGY: 'Delhi University, NIMHANS, TISS, UCL, APA guidelines',
