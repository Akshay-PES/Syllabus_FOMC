...
const BENCHMARKS = {
  ...
  BCOM_ACCA:      'ACCA Global, Melbourne (BCom), Sydney (BCom), UNSW (BCom), Toronto (BCom)',
  BCOM_CMA:       'ICMAI, IMA (USA), Melbourne (BCom), Sydney (BCom), Toronto (BCom)',
  BCOM_CFA:       'CFA Institute, UNSW (BCom-CFA), Toronto (BCom), McGill (BCom)',
  BCOM_CA:        'ICAI, Melbourne (BCom-CA), Sydney (BCom-CA), Toronto (BCom-CPA)',
