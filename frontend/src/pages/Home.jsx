...
const BENCHMARKS = {
  ...
  BCOM_ACCA:      'ACCA Global, MIT, LSE, Oxford, Melbourne, NUS',
  BCOM_CMA:       'ICMAI, IMA (USA), MIT, Stanford, LSE, Oxford',
  BCOM_CFA:       'CFA Institute, MIT, Stanford, LSE, Oxford, NUS',
  BCOM_CA:        'ICAI, MIT, LSE, Oxford, Melbourne, NUS',
  BBA:            'Harvard, INSEAD, London Business School, MIT Sloan, Cambridge, NUS',
  BBA_ANALYTICS:  'MIT, Stanford, ETH Zurich, Carnegie Mellon, Oxford',
  BBA_SPORTS:     'Loughborough, Sydney, Queensland, UBC, KU Leuven',
  BA_LLB:         'Oxford, Cambridge, Harvard Law, Yale Law, LSE, NUS, BCI',
  BBA_LLB:        'Oxford, Cambridge, Harvard Law, Yale Law, LSE, NUS, BCI',
  LLB:            'Oxford, Cambridge, Harvard Law, Yale Law, LSE, NUS, BCI',
  BSC_PSYCHOLOGY: 'Harvard, Stanford, Oxford, Cambridge, Amsterdam, APA guidelines',
  BSC_ECONOMICS:  'MIT, Harvard, Stanford, LSE, Oxford, Cambridge, ETH Zurich',
  BSC_JMC:        'Amsterdam, LSE, USC, NTU Singapore, Melbourne, Goldsmiths',
  BHEM:           'EHL Lausanne, Cornell, Hong Kong PolyU, UNLV, Les Roches',
  MSC_PSYCHOLOGY: 'Harvard, Stanford, Oxford, Cambridge, Amsterdam, APA guidelines',
  LLM:            'Oxford, Cambridge, Harvard Law, Yale Law, LSE, NUS, BCI standards',
};
